export function logMiddleware(dcl: DecentralandInterface): DecentralandInterface {
  const decentralandInterface: DecentralandInterface = {
    ...
    updateEntityComponent: function (entityId: EntityID, componentName: string, classId: number, json: string) {
    ...
    attachEntityComponent: function (entityId: EntityID, componentName: string, componentId: ComponentID) {
    ...
    removeEntityComponent: function (entityId: EntityID, componentName: string) {
    ...
    componentCreated: function (componentId: ComponentID, componentName: string, classId: number) {
