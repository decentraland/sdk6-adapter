import { type ECS6ComponentAnimator, type ECS6ComponentAnimator_AnimationState } from '~system/EngineApi'
...
function convertAnimationState(states: ECS6ComponentAnimator_AnimationState[]): PBAnimationState[] {
...
function update(state: AdaptationLayerState, ecs6EntityId: EntityID, payload: ECS6ComponentAnimator): void {
